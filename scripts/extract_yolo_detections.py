...
from ccskde.context.detect import extract_clip, load_yolo
...
def main() -> None:
    ...
    out_dir = args.out_dir or args.data_root / "context" / args.split
    spec = ContextSpec()
    ...
    print(f"[ccskde] {len(clips)} clips → {out_dir}")
